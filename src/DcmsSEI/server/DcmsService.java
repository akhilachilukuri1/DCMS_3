 ...
 * 
 */
@WebServiceClient(name = "DcmsService", targetNamespace = "http://Server/", wsdlLocation = "http://LAPTOP-7O8GABPD:8080/DCMS_3/DcmsService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://LAPTOP-7O8GABPD:8080/DCMS_3/DcmsService?wsdl");
